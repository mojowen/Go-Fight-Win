/** 
	Ways to attack this:
		...
		- Need to test custom functions (make part of viewModel?)
			- grouping
			- sorting
			- filtering
...
describe("viewModel set ups", function() {

	describe("Rows inside of the viewModel", function() {
	...
	describe("Fields inside of the viewModel", function() {
	  	var row;
